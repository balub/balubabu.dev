...
The cutoff matters here. People continued creating accounts after voting had already closed, so using the current account count would make participation appear to change every time we checked it. For this analysis, I froze the number at the actual close of voting.
...
- **Rank 1:** Minnow: An Open Platform for Ground Swarm Robotics — 17 votes
- **Rank 2:** Build Your Own Open Source Keyboard with ZMK/QMK — 16 votes
- **Rank 2:** Holding It Together: A Talk About Screws — 16 votes
- **Rank 4:** Building Open Source Music Hardware in India – Tarab Instruments — 14 votes
- **Rank 4:** CNC4Everyone — 14 votes
- **Rank 6:** My Zero-to-Hero Journey Deploying a Fiber-Optic and Wireless Community Mesh — 13 votes
...
That is useful. An unused vote tells us something too. It means people were choosing the talks they genuinely wanted rather than treating nine as a target they had to reach.
